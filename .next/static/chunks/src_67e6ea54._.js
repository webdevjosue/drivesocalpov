...
"[project]/src/lib/map/config.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const GTA_MAP_STYLES = {
    ...
    satellite: OPENSTREETMAP_STYLES.stamen_terrain,
...
function getOptimizedConfig() {
    ...
    const isMobile = "object" !== 'undefined' && 'ontouchstart' in window && window.innerWidth <= 768;
...
"[project]/src/store/mapStore.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$map$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/map/config.ts [app-client] (ecmascript)");
...
const useMapStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["devtools"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subscribeWithSelector"])((set, get)=>({
        ...
        // Map style and theme
        mapStyle: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$map$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPENSTREETMAP_STYLES"].osm_standard,
        mapTheme: 'day',
        ...
        setMapTheme: (mapTheme)=>{
            set({
                mapTheme,
                mapStyle: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$map$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GTA_MAP_STYLES"][mapTheme]
            });
        },
        // Boundaries
        boundaries: null,
...
const useMapViewState = ()=>{
    _s();
    return useMapStore({
        "useMapViewState.useMapStore": (state)=>state.viewState
...
const useMapLoadingState = ()=>{
    _s1();
    return useMapStore({
        "useMapLoadingState.useMapStore": (state)=>({
                isLoading: state.isLoading,
                isStyleLoaded: state.isStyleLoaded,
                isSourceLoaded: state.isSourceLoaded,
                error: state.error
            })
    }["useMapLoadingState.useMapStore"]);
};
_s1(useMapLoadingState, "nurWsAZ3N93L89lPaNY0xu41ksw=", false, function() {
    return [
        useMapStore
    ];
});
const useMapInteractionState = ()=>{
    _s2();
    return useMapStore({
        "useMapInteractionState.useMapStore": (state)=>({
                isDragging: state.isDragging,
                isZooming: state.isZooming,
                isRotating: state.isRotating,
                isAnimating: state.isAnimating
            })
    }["useMapInteractionState.useMapStore"]);
};
_s2(useMapInteractionState, "nurWsAZ3N93L89lPaNY0xu41ksw=", false, function() {
    return [
        useMapStore
    ];
});
const useMapPerformanceState = ()=>{
    _s3();
    return useMapStore({
        "useMapPerformanceState.useMapStore": (state)=>({
                performanceMode: state.performanceMode,
                performanceConfig: state.performanceConfig
            })
    }["useMapPerformanceState.useMapStore"]);
};
_s3(useMapPerformanceState, "nurWsAZ3N93L89lPaNY0xu41ksw=", false, function() {
    return [
        useMapStore
    ];
});
const useMapActions = ()=>{
    _s4();
    return useMapStore({
        "useMapActions.useMapStore": (state)=>({
                // Animate to new location
                flyTo: ({
                    "useMapActions.useMapStore": (coordinates, zoom)=>{
                        const { map } = state;
                        if (!map) return;
                        map.flyTo({
                            center: coordinates,
...
_s4(useMapActions, "nurWsAZ3N93L89lPaNY0xu41ksw=", false, function() {
    return [
        useMapStore
    ];
});
const useMapEffect = (effect, deps)=>{
    ...
    const map = useMapStore({
        "useMapEffect.useMapStore[map]": (state)=>state.map
    }["useMapEffect.useMapStore[map]"]);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "useMapEffect.useEffect": ()=>{
            if (map) {
                return effect(map);
            }
        }
...
_s5(useMapEffect, "s3L3WtZ6yykLyRRiZW/v12MShQ0=", false, function() {
    return [
        useMapStore
    ];
});
const useMapPerformanceMonitor = ()=>{
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "useMapPerformanceMonitor.useEffect": ()=>{
            if (!map) return;
            let frameCount = 0;
            let lastTime = performance.now();
            let fpsTimeout;
            const measureFPS = {
                "useMapPerformanceMonitor.useEffect.measureFPS": ()=>{
                    frameCount++;
                    ...
                    if (deltaTime >= 1000) {
                        ...
                        if (fps < 30 && !performanceMode) {
                            console.warn("Low FPS detected: ".concat(fps, ", enabling performance mode"));
                            setPerformanceMode(true);
                        }
                        frameCount = 0;
...
_s6(useMapPerformanceMonitor, "xOriam8YSKW2o6TJ+qpLZFsZXQc=", false, function() {
    return [
        useMapStore
    ];
});
...
function useIsMobile() {
    ...
    const updateDeviceInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useIsMobile.useCallback[updateDeviceInfo]": ()=>{
            ...
            // Connection type
            const connectionType = (connection === null || connection === void 0 ? void 0 : connection.effectiveType) || 'unknown';
            const newDeviceInfo = {
                isMobile,
                isTablet,
                isTouchDevice,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useIsMobile.useEffect": ()=>{
            ...
            const handleOrientationChange = {
                "useIsMobile.useEffect.handleOrientationChange": ()=>{
            ...
            const handleConnectionChange = {
                "useIsMobile.useEffect.handleConnectionChange": ()=>{
                    updateDeviceInfo();
                }
            }["useIsMobile.useEffect.handleConnectionChange"];
            // Add event listeners
...
_s(useIsMobile, "zuLtc8Eg005sLSg1QX60wkhT8/o=");
function useMobileDeviceInfo() {
    ...
    const updateDeviceInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useMobileDeviceInfo.useCallback[updateDeviceInfo]": ()=>{
            const width = window.innerWidth;
            const height = window.innerHeight;
            const pixelRatio = window.devicePixelRatio || 1;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useMobileDeviceInfo.useEffect": ()=>{
            updateDeviceInfo();
            const handleResize = {
                "useMobileDeviceInfo.useEffect.handleResize": ()=>updateDeviceInfo()
            }["useMobileDeviceInfo.useEffect.handleResize"];
            const handleOrientationChange = {
                "useMobileDeviceInfo.useEffect.handleOrientationChange": ()=>setTimeout(updateDeviceInfo, 100)
            }["useMobileDeviceInfo.useEffect.handleOrientationChange"];
            window.addEventListener('resize', handleResize);
            window.addEventListener('orientationchange', handleOrientationChange);
            const connection = navigator.connection;
            if (connection) {
...
_s1(useMobileDeviceInfo, "NKZ4oI6kvbh8nFLi7aZkdusAviA=");
...
_s2(useMobilePerformance, "3TzkEJwCAo1dWocRwlUkszvzKsA=", false, function() {
    return [
        useMobileDeviceInfo
    ];
});
...
"[project]/src/components/map/MapProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$map$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/map/config.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$mapStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/store/mapStore.ts [app-client] (ecmascript)");
...
;
;
function MapProvider(param) {
    let { children, className = '', onMapLoad, onMapError, enablePerformanceMode: enablePerfMode = true } = param;
    _s();
    ...
    const { setMap, mapStyle, setLoading, setStyleLoaded, setError, setPerformanceMode, setViewport } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$mapStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMapStore"])();
    const mapRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const performanceTimerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    // const [mapLoading, setMapLoading] = useState(true)
    // Mobile-optimized configuration
    const mapConfig = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MapProvider.useMemo[mapConfig]": ()=>{
            const baseConfig = {
                ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$map$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MAP_CONFIG"],
                mapStyle: mapStyle || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$map$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MAP_CONFIG"].mapStyle,
                ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$map$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOBILE_PERFORMANCE_CONFIG"]
            };
            // Apply device-specific optimizations
            const deviceConfig = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$map$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOptimizedConfig"])();
    ...
    const handleMapLoad = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MapProvider.useCallback[handleMapLoad]": (event)=>{
            ...
            map.setMaxBounds(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$map$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MAP_CONFIG"].maxBounds);
    ...
    }["MapProvider.useCallback[handleMapLoad]"], [
        isMobile,
        setMap,
        setLoading,
        setStyleLoaded,
    ...
    const handleError = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MapProvider.useCallback[handleError]": (error)=>{
            var _error_error;
            console.error('Map loading error:', error);
            // Set error state
            setError(error);
            // Try to recover from common errors
            if ((_error_error = error.error) === null || _error_error === void 0 ? void 0 : _error_error.message) {
                ...
                if (errorMessage.includes('style') || errorMessage.includes('tile')) {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$map$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MAP_CONFIG"].mapStyle = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$map$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPENSTREETMAP_STYLES"].osm_standard;
                }
                ...
                if (errorMessage.includes('network') || errorMessage.includes('fetch')) {
                    ...
                    setTimeout({
                        "MapProvider.useCallback[handleError]": ()=>{
                            window.location.reload();
                        }
                    }["MapProvider.useCallback[handleError]"], 5000);
                }
            }
    ...
    const setupPerformanceMonitoring = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MapProvider.useCallback[setupPerformanceMonitoring]": (map)=>{
            let frameCount = 0;
            let lastTime = performance.now();
            const measurePerformance = {
                "MapProvider.useCallback[setupPerformanceMonitoring].measurePerformance": ()=>{
                    frameCount++;
                    const currentTime = performance.now();
                    const deltaTime = currentTime - lastTime;
                    if (deltaTime >= 1000) {
                        ...
                        if (fps < 30) {
                            console.warn("Low FPS detected: ".concat(fps, ", enabling performance optimizations"));
    ...
    }["MapProvider.useCallback[setupPerformanceMonitoring]"], [
        setPerformanceMode
    ]);
    // Cleanup on unmount
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MapProvider.useEffect": ()=>{
            const handleResize = {
                "MapProvider.useEffect.handleResize": ()=>{
                    if (mapRef.current) {
                        setViewport({
                            width: window.innerWidth,
                            height: window.innerHeight,
            ...
            window.addEventListener('resize', handleResize);
            return ({
                "MapProvider.useEffect": ()=>window.removeEventListener('resize', handleResize)
            })["MapProvider.useEffect"];
        }
    }["MapProvider.useEffect"], [
        setViewport
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MapProvider.useEffect": ()=>{
            const handleVisibilityChange = {
                "MapProvider.useEffect.handleVisibilityChange": ()=>{
                    if (mapRef.current) {
                        if (document.hidden) {
            ...
            return ({
                "MapProvider.useEffect": ()=>document.removeEventListener('visibilitychange', handleVisibilityChange)
            })["MapProvider.useEffect"];
        }
    }["MapProvider.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "map-provider ".concat(className),
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$vis$2e$gl$2f$react$2d$maplibre$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"], {
            ...
            onMove: (e)=>{
                ...
                if (mapRef.current) {
                    ...
                    const bounds = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$map$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MAP_CONFIG"].maxBounds;
                    ...
                    if (clampedLng !== center.lng || clampedLat !== center.lat) {
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$mapStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMapStore"].getState().setViewState({
            ...
            onMoveStart: ()=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$mapStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMapStore"].getState().setIsDragging(true);
            },
            onMoveEnd: ()=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$mapStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMapStore"].getState().setIsDragging(false);
            },
            onZoomStart: ()=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$mapStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMapStore"].getState().setIsZooming(true);
            },
            onZoomEnd: ()=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$mapStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMapStore"].getState().setIsZooming(false);
                // Enforce zoom bounds
                if (mapRef.current) {
                    const zoom = mapRef.current.getZoom();
                    const minZoom = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$map$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MAP_CONFIG"].minZoom || 8;
                    const maxZoom = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$map$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MAP_CONFIG"].maxZoom || 18;
                    if (zoom < minZoom) {
...
_s(MapProvider, "UJgBSKFw9nyKMTltOuxFBECBdMU=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$mapStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMapStore"]
    ];
});
_c = MapProvider;
function withMapProvider(Component) {
    return function WrappedComponent(param) {
        let { mapProviderProps, ...props } = param;
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MapProvider, {
            ...mapProviderProps || {},
...
"[project]/src/hooks/useMobilePerformance.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useMobilePerformance() {
    ...
    const detectDeviceCapabilities = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useMobilePerformance.useCallback[detectDeviceCapabilities]": ()=>{
            const hardwareConcurrency = navigator.hardwareConcurrency || 4;
            const deviceMemory = navigator.deviceMemory || 4;
            const connection = navigator.connection;
            ...
            return {
                ...
                shouldReduceQuality,
                maxConcurrentRequests,
                connectionType: (connection === null || connection === void 0 ? void 0 : connection.effectiveType) || 'unknown'
            };
        }
    }["useMobilePerformance.useCallback[detectDeviceCapabilities]"], []);
    // FPS monitoring
    const startFPSMonitoring = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useMobilePerformance.useCallback[startFPSMonitoring]": ()=>{
            let animationId;
            const measureFPS = {
                "useMobilePerformance.useCallback[startFPSMonitoring].measureFPS": ()=>{
                    ...
                    if (deltaTime >= 1000) {
                        ...
                        setState({
                            "useMobilePerformance.useCallback[startFPSMonitoring].measureFPS": (prevState)=>({
                                    ...prevState,
                                    metrics: {
                                        ...prevState.metrics,
                                        fps
    ...
    // Memory monitoring
    const startMemoryMonitoring = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useMobilePerformance.useCallback[startMemoryMonitoring]": ()=>{
            const checkMemory = {
                "useMobilePerformance.useCallback[startMemoryMonitoring].checkMemory": ()=>{
                    if (performance.memory) {
                        const memory = performance.memory;
                        const memoryUsage = memory.usedJSHeapSize / memory.totalJSHeapSize;
                        setState({
                            "useMobilePerformance.useCallback[startMemoryMonitoring].checkMemory": (prevState)=>({
                                    ...prevState,
                                    metrics: {
                                        ...prevState.metrics,
                                        memoryUsage
            ...
            return ({
                "useMobilePerformance.useCallback[startMemoryMonitoring]": ()=>clearInterval(interval)
            })["useMobilePerformance.useCallback[startMemoryMonitoring]"];
        }
    }["useMobilePerformance.useCallback[startMemoryMonitoring]"], []);
    // Network performance monitoring
    const startNetworkMonitoring = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useMobilePerformance.useCallback[startNetworkMonitoring]": ()=>{
            const observer = new PerformanceObserver({
                "useMobilePerformance.useCallback[startNetworkMonitoring]": (list)=>{
                    list.getEntries().forEach({
                        "useMobilePerformance.useCallback[startNetworkMonitoring]": (entry)=>{
                            if (entry.entryType === 'resource') {
                                ...
                                if (resource.responseStart > 0) {
                                    ...
                                    setState({
                                        "useMobilePerformance.useCallback[startNetworkMonitoring]": (prevState)=>({
                                                ...prevState,
                                                metrics: {
                                                    ...prevState.metrics,
    ...
    const startDeviceLoadMonitoring = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useMobilePerformance.useCallback[startDeviceLoadMonitoring]": ()=>{
            const checkDeviceLoad = {
                "useMobilePerformance.useCallback[startDeviceLoadMonitoring].checkDeviceLoad": ()=>{
                    ...
                    setState({
                        "useMobilePerformance.useCallback[startDeviceLoadMonitoring].checkDeviceLoad": (prevState)=>({
                                ...prevState,
                                metrics: {
                                    ...prevState.metrics,
                                    deviceLoad
            ...
            return ({
                "useMobilePerformance.useCallback[startDeviceLoadMonitoring]": ()=>clearInterval(interval)
            })["useMobilePerformance.useCallback[startDeviceLoadMonitoring]"];
        }
    }["useMobilePerformance.useCallback[startDeviceLoadMonitoring]"], [
        state.metrics.fps,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useMobilePerformance.useEffect": ()=>{
            const deviceCapabilities = detectDeviceCapabilities();
            setState({
                "useMobilePerformance.useEffect": (prevState)=>({
                        ...prevState,
                        ...deviceCapabilities,
            ...
            return ({
                "useMobilePerformance.useEffect": ()=>{
                    ...
                    observersRef.current.forEach({
                        "useMobilePerformance.useEffect": (observer)=>observer.disconnect()
                    }["useMobilePerformance.useEffect"]);
                }
            })["useMobilePerformance.useEffect"];
        }
    ...
    const optimizePerformance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useMobilePerformance.useCallback[optimizePerformance]": function() {
            let aggressive = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false;
            setState({
                "useMobilePerformance.useCallback[optimizePerformance]": (prevState)=>({
                        ...prevState,
                        isPerformanceMode: true,
                        shouldReduceAnimations: true,
            ...
            }["useMobilePerformance.useCallback[optimizePerformance]"]);
        }
    }["useMobilePerformance.useCallback[optimizePerformance]"], []);
    const restorePerformance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useMobilePerformance.useCallback[restorePerformance]": ()=>{
            const deviceCapabilities = detectDeviceCapabilities();
            setState({
                "useMobilePerformance.useCallback[restorePerformance]": (prevState)=>({
                        ...prevState,
                        isPerformanceMode: false,
                        ...deviceCapabilities
                    })
    ...
    const getRecommendations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useMobilePerformance.useCallback[getRecommendations]": ()=>{
...
_s(useMobilePerformance, "kUcG9rBpA+Jy8d/2Q0UFtf1mVcQ=");
function useMapPerformance() {
    _s1();
    const performanceState = useMobilePerformance();
    const [mapMetrics, setMapMetrics] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        tileCount: 0,
        markersLoaded: 0,
        lastRenderTime: 0
    });
    // Monitor map-specific metrics
    const updateMapMetrics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useMapPerformance.useCallback[updateMapMetrics]": (updates)=>{
            setMapMetrics({
                "useMapPerformance.useCallback[updateMapMetrics]": (prev)=>({
                        ...prev,
                        ...updates
                    })
            }["useMapPerformance.useCallback[updateMapMetrics]"]);
        }
    }["useMapPerformance.useCallback[updateMapMetrics]"], []);
    return {
        ...performanceState,
...
_s1(useMapPerformance, "Qa1Yv65gnDsvBugoc+jnABbzUjQ=", false, function() {
    return [
        useMobilePerformance
    ];
});
function usePerformanceAnimation() {
    ...
    const getAnimationDuration = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "usePerformanceAnimation.useCallback[getAnimationDuration]": (baseDuration)=>{
    ...
    }["usePerformanceAnimation.useCallback[getAnimationDuration]"], [
        shouldReduceAnimations,
        metrics.fps
    ]);
    const shouldAnimate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "usePerformanceAnimation.useCallback[shouldAnimate]": ()=>{
...
_s2(usePerformanceAnimation, "e6XX9/V3AXZkp1fINVVqIBPKHVw=", false, function() {
    return [
        useMobilePerformance
    ];
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$map$2f$MapProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/map/MapProvider.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$mapStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/store/mapStore.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useMobilePerformance$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useMobilePerformance.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
;
;
function MapContainer(param) {
    let { className = '', children, showControls = true, enablePerformanceMode: enablePerfMode = true } = param;
    _s();
    const { isLowEndDevice, shouldReduceAnimations, shouldReduceQuality } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useMobilePerformance$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMobilePerformance"])();
    const { error, isLoading, performanceMode } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$mapStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMapStore"])();
    // Handle map load
    const handleMapLoad = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useCallback({
        "MapContainer.useCallback[handleMapLoad]": (map)=>{
            console.log('Map loaded successfully:', {
    ...
    }["MapContainer.useCallback[handleMapLoad]"], []);
    // Handle map error
    const handleMapError = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useCallback({
        "MapContainer.useCallback[handleMapError]": (error)=>{
            console.error('Map error:', error);
        }
    }["MapContainer.useCallback[handleMapError]"], []);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$map$2f$MapProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MapProvider"], {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PerformanceIndicator, {}, void 0, false, {
                    fileName: "[project]/src/components/map/MapContainer.tsx",
                    lineNumber: 116,
                    columnNumber: 9
                }, this),
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ErrorOverlay, {}, void 0, false, {
                    fileName: "[project]/src/components/map/MapContainer.tsx",
                    lineNumber: 122,
                    columnNumber: 9
                }, this)
...
_s(MapContainer, "MK1LY6C0QmTOfxwwo76IVEcGKxE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useMobilePerformance$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMobilePerformance"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$mapStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMapStore"]
    ];
});
_c = MapContainer;
...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$map$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateMapEnvironment"])();
        }
    }["Home.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=src_67e6ea54._.js.map